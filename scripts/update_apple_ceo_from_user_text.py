...
ROOT = find_repo_root()
APPLE_FILE = ROOT / "OpenClaw/Data/apple_ceo_class.json"
...
student_rounds = [
    {
        ...
        "aliases": ["方醫師"],
        "rounds": [
            round_item("最新梯次 (進行中)", ["2026-03-26", "2026-04-09", "2026-04-30", "2026-05-07", "2026-05-14"], "未標示收款"),
            ...
            round_item("2025 夏季梯次", ["2025-06-12", "2025-06-19", "2025-07-03", "2025-07-10", "2025-07-24", "2025-07-31", "2025-08-07", "2025-07-14"], "第 8 堂原始資料為 7/14，需人工確認是否為 8/14"),
        ],
    },
    {
        "student_name": "劉邦寧",
        "aliases": ["邦寧大哥"],
        "rounds": [
            round_item("最新梯次 (進行中)", ["2026-03-27", "2026-04-09", "2026-04-16", "2026-04-23", "2026-04-30"], "4/12 收到學費 $8000；3/27 原始註記未收"),
    ...
    },
    {
        "student_name": "王太太",
        "rounds": [
            round_item("最新梯次 (進行中)", ["2025-09-11", "2026-01-29", "2026-02-05", "2026-02-26", "2026-03-05", "2026-04-16"]),
    ...
    },
    {
        ...
        "aliases": ["Roger"],
        "rounds": [
            round_item("最新梯次 (進行中)", ["2026-04-09", "2026-04-16", "2026-04-23", "2026-04-30", "2026-05-07", "2026-05-14"], "4/9 收到學費 $8000；第 5 堂由原始 4/7 依出勤紀錄校正為 5/7"),
    ...
    },
    {
        ...
        "aliases": ["Lucia 徐露華"],
        "rounds": [
            round_item("最新梯次 (進行中)", ["2026-01-29", "2026-03-05", "2026-03-12", "2026-03-19", "2026-04-09", "2026-05-07", "2026-05-14"]),
...
def main() -> None:
    payload = {
        ...
        "tuition_records": [
            {"date": "2026-04-09", "student_name": "Roger老師", "amount": 8000, "note": "收到 Roger 學費"},
            {"date": "2026-04-12", "student_name": "劉邦寧", "amount": 8000, "note": "收到邦寧大哥學費"},
        ],
        "legacy_note": "2026-05-17 依使用者提供文字重建：課程規則、場地資訊、場地流水、出勤紀錄與學員 8 堂梯次。小樹屋兩筆場地費保留於出勤與流水備註，但不併入玫瑰客廳預付餘額。",
    }
    payload["duplicate_report"] = duplicate_report(payload)

    APPLE_FILE.write_text(
        json.dumps(payload, ensure_ascii=False, indent=2) + "\n",
        encoding="utf-8",
    )
    print(json.dumps(payload["duplicate_report"], ensure_ascii=False, indent=2))
